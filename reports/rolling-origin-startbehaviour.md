...
Generated 2026-08-28T17:19:13.153Z over 10 seasons (2016-17, 2017-18, 2018-19, 2019-20, 2020-21, 2021-22, 2022-23, 2023-24, 2024-25, 2025-26), 253,568 archive rows. Training window: every earlier season. Season half-life: none — every season counts equally. Imputed start labels: not used. Window and decay: fixed for every fold. Player rates: the flat career mean. Starter minutes: each player's OWN E[minutes | started] and P(60+ | started), shrunk (plan 028 task 3). Availability: plan 024's fitted flags.
...
| per-player start behaviour vs league constants | 2024-25 | 37 | +0.4% | 0.7% | no |
| model vs form | 2025-26 | 19 | +5.1% | 2.0% | yes |
| model vs priorSeason | 2025-26 | 19 | +25.7% | 2.2% | yes |
| per-player start behaviour vs league constants | 2025-26 | 19 | +1.1% | 1.1% | no |
...
|---|---:|---:|---:|---|---|
| model vs form | 2 | +4.2% | 0.9% | yes | 2024-25 +3.2%, 2025-26 +5.1% |
| model vs priorSeason | 2 | +19.1% | 6.6% | yes | 2024-25 +12.5%, 2025-26 +25.7% |
| per-player start behaviour vs league constants | 2 | +0.7% | 0.3% | yes | 2024-25 +0.4%, 2025-26 +1.1% |
...
**model vs form** — +4.2% captured@11 across 2 folds, se 0.9%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**

**model vs priorSeason** — +19.1% captured@11 across 2 folds, se 6.6%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**

**per-player start behaviour vs league constants** — +0.7% captured@11 across 2 folds, se 0.3%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**
