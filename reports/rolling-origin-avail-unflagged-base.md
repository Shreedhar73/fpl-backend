...
Generated 2026-08-28T16:44:18.691Z over 10 seasons (2016-17, 2017-18, 2018-19, 2019-20, 2020-21, 2021-22, 2022-23, 2023-24, 2024-25, 2025-26), 253,568 archive rows. Training window: every earlier season. Season half-life: none — every season counts equally. Imputed start labels: not used.
...
|---|---:|---:|---:|
| 2024-25 | 0.2818 | 0.4316 | 0.1544 |
| 2025-26 | 0.3333 | 0.4851 | 0.1544 |

## Paired per-round difference, within each fold

| comparison | eval season | rounds | mean Δ captured@11 | 1 se | clears 2se |
|---|---|---:|---:|---:|---|
| model vs form | 2024-25 | 37 | +3.3% | 1.8% | no |
| model vs priorSeason | 2024-25 | 38 | +12.4% | 1.7% | yes |
| availability unflagged-base vs none | 2024-25 | 37 | +0.2% | 0.3% | no |
| model vs form | 2025-26 | 19 | +4.4% | 2.1% | yes |
| model vs priorSeason | 2025-26 | 19 | +25.7% | 1.9% | yes |
| availability unflagged-base vs none | 2025-26 | 19 | -0.5% | 0.8% | no |
...
|---|---:|---:|---:|---|---|
| model vs form | 2 | +3.9% | 0.5% | yes | 2024-25 +3.3%, 2025-26 +4.4% |
| model vs priorSeason | 2 | +19.0% | 6.6% | yes | 2024-25 +12.4%, 2025-26 +25.7% |
| availability unflagged-base vs none | 2 | -0.1% | 0.4% | no | 2024-25 +0.2%, 2025-26 -0.5% |
...
**model vs form** — +3.9% captured@11 across 2 folds, se 0.5%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**

**model vs priorSeason** — +19.0% captured@11 across 2 folds, se 6.6%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**

**availability unflagged-base vs none** — -0.1% captured@11 across 2 folds, se 0.4%. Does NOT clear twice the between-fold error, so this comparison is undecided at this fold count however the mean points. The per-fold means do not agree on a sign, which is the thing a single holdout cannot show you. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**
