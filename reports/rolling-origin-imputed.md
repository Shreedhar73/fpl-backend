...
| 2018-19 | -0.2014 | 0.1707 | 0.1460 |
| 2019-20 | -0.1950 | 0.1653 | 0.1486 |
| 2020-21 | -0.1896 | 0.1607 | 0.1502 |
| 2021-22 | -0.1951 | 0.1653 | 0.1497 |
| 2022-23 | -0.2045 | 0.1732 | 0.1452 |
| 2023-24 | -0.2150 | 0.1822 | 0.1449 |
| 2024-25 | 0.0709 | 0.4090 | 0.1461 |
| 2025-26 | 0.1705 | 0.4646 | 0.1473 |
...
| model vs form | 2019-20 | 36 | -9.6% | 2.2% | yes |
| model vs priorSeason | 2019-20 | 38 | -1.7% | 1.9% | no |
| model vs form | 2020-21 | 37 | -15.9% | 2.3% | yes |
| model vs priorSeason | 2020-21 | 38 | -7.5% | 2.4% | yes |
...
| model vs form | 2023-24 | 37 | -1.1% | 1.7% | no |
| model vs priorSeason | 2023-24 | 38 | +16.0% | 1.8% | yes |
| model vs form | 2024-25 | 37 | +2.2% | 1.8% | no |
| model vs priorSeason | 2024-25 | 38 | +11.0% | 1.7% | yes |
| model imputed vs model recorded-only | 2024-25 | 37 | -0.7% | 0.5% | no |
| model vs form | 2025-26 | 19 | +3.5% | 2.1% | no |
| model vs priorSeason | 2025-26 | 19 | +25.1% | 1.9% | yes |
| model imputed vs model recorded-only | 2025-26 | 19 | -0.6% | 0.7% | no |
...
|---|---:|---:|---:|---|---|
| model vs form | 9 | -8.7% | 2.8% | yes | 2017-18 -16.0%, 2018-19 -8.3%, 2019-20 -9.6%, 2020-21 -15.9%, 2021-22 -14.6%, 2022-23 -18.6%, 2023-24 -1.1%, 2024-25 +2.2%, 2025-26 +3.5% |
| model vs priorSeason | 9 | +2.3% | 4.1% | no | 2017-18 -6.7%, 2018-19 +1.6%, 2019-20 -1.7%, 2020-21 -7.5%, 2021-22 -10.1%, 2022-23 -7.1%, 2023-24 +16.0%, 2024-25 +11.0%, 2025-26 +25.1% |
| model imputed vs model recorded-only | 2 | -0.6% | 0.1% | yes | 2024-25 -0.7%, 2025-26 -0.6% |
...
**model vs form** — -8.7% captured@11 across 9 folds, se 2.8%. Clears twice the between-fold error. The per-fold means do not agree on a sign, which is the thing a single holdout cannot show you.
...
**model imputed vs model recorded-only** — -0.6% captured@11 across 2 folds, se 0.1%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**
