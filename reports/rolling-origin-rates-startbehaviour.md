...
Generated 2026-08-29T04:03:27.789Z over 10 seasons (2016-17, 2017-18, 2018-19, 2019-20, 2020-21, 2021-22, 2022-23, 2023-24, 2024-25, 2025-26), 253,568 archive rows. Training window: every earlier season. Season half-life: none — every season counts equally. Imputed start labels: not used. Window and decay: fixed for every fold. Player rates: half-life and shrinkage CHOSEN per fold, on the season before it (plan 028). Starter minutes: each player's OWN E[minutes | started] and P(60+ | started), shrunk (plan 028 task 3). Availability: plan 024's fitted flags.
...
|---|---|---:|---:|---:|---|
| model vs form | 2024-25 | 37 | +3.2% | 1.9% | no |
| model vs priorSeason | 2024-25 | 38 | +12.3% | 1.8% | yes |
| plan 028 model shape vs the incumbent | 2024-25 | 37 | +0.3% | 0.7% | no |
| model vs form | 2025-26 | 19 | +5.8% | 2.1% | yes |
| model vs priorSeason | 2025-26 | 19 | +25.9% | 1.8% | yes |
| plan 028 model shape vs the incumbent | 2025-26 | 19 | +1.7% | 1.7% | no |
...
| model vs priorSeason | 2 | +19.1% | 6.8% | yes | 2024-25 +12.3%, 2025-26 +25.9% |
| plan 028 model shape vs the incumbent | 2 | +1.0% | 0.7% | no | 2024-25 +0.3%, 2025-26 +1.7% |
...
**model vs priorSeason** — +19.1% captured@11 across 2 folds, se 6.8%. Clears twice the between-fold error. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**

**plan 028 model shape vs the incumbent** — +1.0% captured@11 across 2 folds, se 0.7%. Does NOT clear twice the between-fold error, so this comparison is undecided at this fold count however the mean points. Every fold agrees on the sign. **Read the clearance with the fold count in front of it: an error estimated from 2 numbers is itself barely estimated, and two folds that happen to agree produce a small standard error whether or not the effect is real. This is a direction, not a decision.**
